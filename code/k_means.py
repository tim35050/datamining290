...
def pick_centroids(xs, num):
    ...
    ###
    # Randomly pick num centroids from  uniform distribution formed from min and max of dataset
    centroids = []
    for i in range(num):
...
def distance(a, b):
    ...
    ###
    # distance defined as absolute difference
    return abs(a - b)
    ##/
...
def centroid(xs):
    ...
    ###
    # Calculate centroid as mean of numbers in list
